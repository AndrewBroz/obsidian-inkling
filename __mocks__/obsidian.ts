...
export class Events {
	on(..._args: any[]) { return { unsubscribe: () => {} }; }
	off(..._args: any[]) {}
	offref(..._args: any[]) {}
	trigger(..._args: any[]) {}
...
export class ItemView extends Component {
	constructor(public leaf?: any) { super(); }
...
export class WorkspaceLeaf {
	view: any;
	openFile(..._args: any[]) { return Promise.resolve(); }
	setViewState(..._args: any[]) { return Promise.resolve(); }
}
...
export function debounce<T extends (...args: any[]) => any>(fn: T, _timeout?: number, _resetTimer?: boolean): T & { cancel?: () => void } {
